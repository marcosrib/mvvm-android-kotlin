package com.example.applicationestudo.adapters
...
class MainAdapter(private val onItemClicked: (Live) -> Unit) : RecyclerView.Adapter<MainViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): MainViewHolder {
        ...
        val binding = ResItemLivesBinding.inflate(inflater, parent, false)
...
class MainViewHolder(val binding: ResItemLivesBinding) : RecyclerView.ViewHolder(binding.root) {
